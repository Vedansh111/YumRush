        ...
        <div className='header sticky top-0 bg-white bg-opacity-80 shadow-md flex items-center justify-between px-8 z-10'>
            ...
            <nav>
                <ul className="flex items-center text-xl text-gray-600">
                    ...
                    <li><Link to="/cart" className="px-4 py-1.5 hover:text-blue-700 duration-200">
                        <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="shopping-cart" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" className="h-5 w-5 fa-shopping-cart ml-2">
